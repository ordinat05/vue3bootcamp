  ...
  <div class="form-area card border p-2">
    <div class="mb-3">
      ...
      <input
        ...
        class="form-control"
        id="title"
        placeholder="kablosuzkedi resmi doküman"
      />
    </div>
    <div class="mb-3">
    ...
    <div class="d-flex justify-content-end align-items-center">
      ...
      <!-- <button class="btn btn-sm btn-secondary me-2" @click="$router.go(-1)">
        Bir geriye butonu ⏰01:44:20
      </button> -->
  ...
  methods: {
    onSave() {
      ...
      this.$appAxios.post("/bookmarks", this.userData).then((save_response) => {
        console.log("Kaydedilen_response", save_response);
        this.resetData();
        this.$router.push("/");
      });
    },
